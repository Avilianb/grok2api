...
var schemaModels = []any{
	...
	&publicModelMappingModel{},
	&publicModelMappingTargetModel{},
...
var schemaIndexes = []string{
	...
	"CREATE UNIQUE INDEX IF NOT EXISTS idx_public_model_mappings_external_id ON public_model_mappings(external_id)",
	"CREATE INDEX IF NOT EXISTS idx_public_model_mappings_enabled ON public_model_mappings(enabled, external_id)",
	"CREATE INDEX IF NOT EXISTS idx_mapping_targets_mapping_priority ON public_model_mapping_targets(mapping_id, priority ASC, id ASC)",
